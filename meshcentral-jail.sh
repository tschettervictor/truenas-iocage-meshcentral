...
iocage exec "${JAIL_NAME}" "pw user add meshcentral -c meshcentral -u 6374 -s /usr/sbin/nologin -d /home/meshcentral -m"
...
echo "---------------"
echo "Using your web browser, go to https://${HOST_NAME}:1025 to start setup"
echo "---------------"
